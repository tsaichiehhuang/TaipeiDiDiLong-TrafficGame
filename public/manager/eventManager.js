...
class EventManager {
    ...
    _updateScore = (eventID, status) => {
        ...
        const changedScore =
            status === EventStatus.SUCCESS
                ? this.events[eventID].SuccessScore
                : this.events[eventID].FailScore;
    ...
    _endEvent = (eventId, endStatus, delay = 0, deleteEvent = true) => {
        setTimeout(() => {
            ...
            let waitingEvent = [
                "event_id_report_red_line_parking",
                "event_report_double_parking",
                "event_report_crpss_hatch_parking",
                "event_report_double_parking",
            ...
            // If so, update score
            if (
                endStatus === EventStatus.SUCCESS ||
                endStatus === EventStatus.FAIL
            ) {
