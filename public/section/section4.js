const Section4 = () => {
    ...
    return {
        ...
        draw: () => {
            ...
            image(this._crossHatchParkingVio, gameManager.getRoadXRange()[0] + 12, startPosiY - 600)
            ...
            if (gameManager.getSection() == 4) {
                ...
                if (currentEvents.has(EVENT_LEVEL_BUY_DINNER)) {
                    ...
                    if (
                        ...
                        playerController.getPlayer().position.x > gameManager.getRoadXRange()[1] &&
                    ...
                    if (
                        ...
                        playerController.getPlayer().position.y =
                            startPosiY_buyDinner - 330 - playerController.playerHeight
                    ...
                    if (
                        ...
                        playerController.getPlayer().position.x >
                            gameManager.getRoadXRange()[1] + playerController.playerWidth / 2 &&
                        playerController.getPlayer().position.x < maxRoadX
                    ) {
