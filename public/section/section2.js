const Section2 = () => {
    ...
    return {
            ...
            if (gameManager.getSection() == 2) {
                ...
                if (currentEvents.has(EVENT_LEVEL_BUY_DRINK)) {
                    ...
                    if (
                        ...
                        playerController.getPlayer().position.y =
                            startPosiY_buyDrink - 330 - playerController.playerHeight
        ...
        onSectionEnd: () => {
            ...
            eventManager.clearListeners([EVENT_REPORT_DOUBLE_PARKING, EVENT_LEVEL_BUY_DRINK])
